function ant_pheromone_trail3

% this function is for the case where 5,000 ants enter into the system 
...
%Storing statics
sProbs   = 0;
stats=zeros(51,1); % for 5000 ants
...
%stating the timer
tic 
% In this iterations 5,000 ants are going to enter the system 
