function ant_pheromone_trail2

% this function is for the case where 10,000 ants enter into the system 
...
%Storing statics
sProbs   = 0;
stats=zeros(101,1); %for 10000 ants
...
%stating the timer
tic 
% In this iterations 10,000 ants are going to enter the system 
