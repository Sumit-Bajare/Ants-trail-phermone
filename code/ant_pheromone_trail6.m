function ant_pheromone_trail6

% this function is for the case where 100 ants enter into the system 
...
%stating the timer
tic 
% In this iterations 100 ants are going to enter the system 
