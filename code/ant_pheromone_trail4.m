function ant_pheromone_trail4

% this function is for the case where 2,500 ants enter into the system 
...
%stating the timer
tic 
% In this iterations 2,500 ants are going to enter the system 
